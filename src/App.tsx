...
import { USER_BADGES, SCIENTIFIC_NODES, EXPEDITIONS } from './data/mockData';
...
export function App() {
  ...
  const [claims, setClaims] = useState(polarDataService.getClaims());
  const [facts, setFacts] = useState(polarDataService.getFacts());
  ...
  useEffect(() => {
    void polarDataService.hydrateReports();
    void polarDataService.hydrateExpeditions();
    void polarDataService.hydrateMedia();
    void polarDataService.hydrateClaims();
    void polarDataService.hydrateEvidence();
    void polarDataService.hydrateCommunityPosts();
    void polarDataService.hydrateUserReports();
    void polarDataService.hydrateFacts();
    void polarDataService.hydrateInteractions();
    void polarDataService.hydrateCyberLogs();
    const unsub = polarDataService.subscribe(() => {
      setReports(polarDataService.getReports());
      setClaims(polarDataService.getClaims());
